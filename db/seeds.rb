...
book.photos.attach([
  {
    io: File.open('public/Book/HP_chamber_of_secrets_xnxsmk.jpeg'),
    filename: 'anyname.jpg',
    content_type: 'image/jpg'
  },
  {
    io: File.open('public/Book/HP_chamber_of_secrets2_l81cww.jpeg'),
    filename: 'anyname.jpg',
    content_type: 'image/jpg'
  },
  {
    io: File.open('public/Book/HP_chamber_of_secrets3_xow9dc.jpeg'),
    filename: 'anyname.jpg',
    content_type: 'image/jpg'
  }
])
